...
1. Clone the repo
   ```sh
   git clone https://github.com/AntonioValentinSayago/javascript-lit-element_V2.0
   ```
...
See the [open issues](https://github.com/AntonioValentinSayago/javascript-lit-element_V2.0/issues) for a list of proposed features (and known issues).
